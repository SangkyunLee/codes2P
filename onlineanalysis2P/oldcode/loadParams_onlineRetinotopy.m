...
% 
% modified by Sangkyun Lee, v2 2015-07-07 for NB208 in the neurosensory
% building
...
[stimparam_file,PathName] = uigetfile({'*.edr;*.csv'},'Select the edr file');
Params.files.mainpath=PathName;
Params.files.DAQfn = stimparam_file;
