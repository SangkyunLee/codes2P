function timeinfo = gen_stimtime_GratingExperiment2Photon(Params)
% % function timeinfo = gen_stimtime_GratingExperiment2Photon(Params)
...
for iblk=1:nblks
    ...
    for istim=1:stimleninblk
        ...
        if bincomplete,
            ...
            if isfield(Params.stimparam,'stim1_samplesinNI')
                edpoint = stpoint + round(Params.stimparam.stim1_samplesinNI)-1;
            elseif isfield(Params.stimparam,'stim_samplesinNI')
                edpoint = stpoint + round(Params.stimparam.stim_samplesinNI)-1;
            end
