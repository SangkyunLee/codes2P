function Params = loadParams_GratingExperiment2Photon_new(Params)
...
j = start;
for i = 1:stimparam.repetitions-1    
        
    j = j + round((stimparam.blank_samplesinNI + stimparam.stim_samplesinNI)*0.9) ;
