function [pixel_list,nuc_list,boundary_inner,boundary_outer,boundary_list]=donut_roi2(map,center,cell_radius,expand_factor,plot_flag)

%% DONUT_ROI2.m  Select donut shaped ROI around a selected point
%    
%% Input Arguments
...
%   modified 2013-10-10, by Sangkyun Lee
...
pathinxs = path + [0:nsample:nsample*(length(path)-1)];


thick_inner = mean(path)/nsample*full_radius*0.4;
thick_outter = mean(path)/nsample*full_radius*0.1;
