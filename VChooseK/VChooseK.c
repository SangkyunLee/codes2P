//mex -largeArrayDims -O CFLAGS="\$CFLAGS -std=c99" VChooseK.c
...
#define ERROR_LIMIT 5000000000L   // 1 GB (recommended for 32&64 bit systems)
...
//void Elem6_1Byte(INT8_T  *Xp, mwSize nX, INT8_T  *Yp, mwSize nY);
  ...
  switch (K) {
    ...
    /*case 6:  // K == 6:
      switch (ElementSize) {
        ...
        case 1:  Elem6_1Byte((INT8_T *) mxGetData(X), nX,
                             (INT8_T *) mxGetData(plhs[0]), nY);
                 break;
        default: BadInputTypeError();
      }
