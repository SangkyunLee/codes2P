...
button_pos0 = [round(0.8*winwidth) round(0.05*winheight*(1)),round(winwidth*0.13) round(winheight*0.06)]; 
...
button_pos1 = [round(0.24*winwidth) round(0.05*winheight*(1)),round(winwidth*0.13) round(winheight*0.06)]; 
...
button_pos2 = [button_pos1(1)+round(winwidth*0.14) round(0.05*winheight*(1)),round(winwidth*0.13) round(winheight*0.06)];
